...
PAPER_AUTOMATION_TABLES: dict[str, str] = {
    ...
    "canonical_pool_state": "symbol TEXT, current_layer TEXT, updated_at TEXT, has_active_order INTEGER, payload_json TEXT",
    "canonical_pool_transition_events": "transition_id TEXT, timestamp_utc TEXT, symbol TEXT, from_layer TEXT, to_layer TEXT, triggering_component TEXT, reason_code TEXT, explanation TEXT, score REAL, market_data_timestamp TEXT, trace_id TEXT, payload_json TEXT",
